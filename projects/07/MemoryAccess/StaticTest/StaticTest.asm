...
// (-15) push static 3
@16 // push static 3 // static + src segment offset (..\projects\07\MemoryAccess\StaticTest\StaticTest.vm)
D=A
@3
A=D+A
D=M
...
// (-17) push static 1
@16 // push static 1 // static + src segment offset (..\projects\07\MemoryAccess\StaticTest\StaticTest.vm)
D=A
@1
A=D+A
D=M
...
// (-21) push static 8
@16 // push static 8 // static + src segment offset (..\projects\07\MemoryAccess\StaticTest\StaticTest.vm)
D=A
@8
A=D+A
D=M
